      ...
      <div className="mb-6">
        <div className="flex items-center justify-between gap-3 mb-1">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <h2 className="text-2xl font-bold text-gray-900 truncate">{instance.title}</h2>
            <span className={cn('text-xs px-2 py-0.5 rounded-full font-medium flex-shrink-0', statusColor(instance.status))}>
          ...
          {instance.status === 'in_progress' && user?.id === instance.created_by && (
            confirmCancel ? (
              ...
              <button
                ...
                className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-600 border border-gray-300 hover:border-red-300 hover:text-red-600 hover:bg-red-50 rounded-md transition-colors"
              >
